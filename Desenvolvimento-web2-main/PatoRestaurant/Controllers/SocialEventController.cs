...
namespace PatoRestaurant.Controllers
{
    public class SocialEventController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,EventDate,Image,Banner")] SocialEvent socialEvent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("Id,Name,Description,EventDate,Image,Banner")] SocialEvent socialEvent)
        {
        ...
        private bool SocialEventExists(short id)
        {
